    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        insertPlayerBank(player_id, amount, transactionId, 'approved')
            .then((response) => {
                ...
                insertPurchasePoints(player_id, PointsToUpload, 600).then((data) => {
                ...
                <div>
                    ...
                    >
                        {!paymentSuccessMessage ? (
                            ...
                            <p className="text-green-500 font-bold text-center">Payment successful!</p>
                        )}
                    </form>
