...
import { updatePlayerActivity_Daily, UpdateState } from '@/app/lib/actions';
import { useActionState } from 'react'

export default function UpdateForm_Daily({ player_id, total_points, balance, points, selectNumber }:
    ...
    // points=currentPoints - passing the value which not part of the form
    const updatePlayerActivityWithCurrentPoints = updatePlayerActivity_Daily.bind(null, points)
