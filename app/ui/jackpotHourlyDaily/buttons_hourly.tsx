...
export function CollectPoints_hourly({ playerId, game_id, selectNumber, takenNumber, balancePoints }:
  {
    playerId: string, game_id: string, selectNumber: number,
    takenNumber: number, balancePoints: number   
  }) {
  ...
  return (
    <Link
      href={{
        pathname: '/dashboard/jackpotHourly/updatePoints', query: {
          playerId: playerId,
